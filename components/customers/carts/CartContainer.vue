    ...
    <div align="end" class="pa-10">
        <v-row>
            <v-col cols="12">
             ...
             <v-col cols="12">
                 <div>
                    <v-btn depressed color="#222f3e" :disabled="events.length==0" dark @click="routeCheckout" :loading="isLoaded" width="300"> Checkout </v-btn>
                    </div>
            </v-col>
        </v-row>
  ...
  methods: {
    ...
    async deleteValue(){
     this.buttonLoad=true
      this.$axios.delete(`/carts/${this.selectedItem.id}/`,{
        headers:{
